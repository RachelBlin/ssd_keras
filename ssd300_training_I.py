...
sgd = optimizers.SGD(lr=1e-5, clipnorm=0.001)
...
images_train_dir      = '/home/2017018/rblin01/BD_QCAV/train_polar/PARAM_POLAR/RetinaNet_I'
images_test_dir      = '/home/2017018/rblin01/BD_QCAV/test_polar/PARAM_POLAR/RetinaNet_I'
...
model_checkpoint = ModelCheckpoint(filepath='/home/2017018/rblin01/networks/ssd_keras/ssd300_I_epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
...
csv_logger = CSVLogger(filename='/home/2017018/rblin01/networks/ssd_keras/ssd300_I_training_log.csv',
                       separator=',',
                       append=True)
