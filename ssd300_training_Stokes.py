...
train_dataset.create_hdf5_dataset(file_path='/home/2017018/rblin01/networks/ssd_keras/dataset_Stokes_trainval.h5',
                                  resize=False,
                                  variable_image_size=True,
                                  verbose=True)

val_dataset.create_hdf5_dataset(file_path='/home/2017018/rblin01/networks/ssd_keras/dataset_Stokes_test.h5',
                                resize=False,
                                variable_image_size=True,
                                verbose=True)
...
model_checkpoint = ModelCheckpoint(filepath='/home/2017018/rblin01/networks/ssd_keras/ssd300_Stokes_epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
...
csv_logger = CSVLogger(filename='/home/2017018/rblin01/networks/ssd_keras/ssd300_Stokes_training_log.csv',
                       separator=',',
                       append=True)
